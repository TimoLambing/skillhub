...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/button-close/primary.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const primary = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { primary as default };
//# sourceMappingURL=primary-e3a00833.mjs.map
