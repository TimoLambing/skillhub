import { l as _export_sfc, b as _sfc_main$o } from '../server.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_BaseParagraph, { class: "text-muted-400 dark:text-muted-400" }, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/typography/paragraph.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const paragraph = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { paragraph as default };
//# sourceMappingURL=paragraph-0224f506.mjs.map
