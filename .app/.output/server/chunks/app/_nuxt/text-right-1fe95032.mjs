...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/dropdown/text-right.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const textRight = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { textRight as default };
//# sourceMappingURL=text-right-1fe95032.mjs.map
