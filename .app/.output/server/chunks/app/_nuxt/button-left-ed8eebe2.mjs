...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/dropdown/button-left.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const buttonLeft = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { buttonLeft as default };
//# sourceMappingURL=button-left-ed8eebe2.mjs.map
