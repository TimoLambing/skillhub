...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/icon-button/loading.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const loading = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { loading as default };
//# sourceMappingURL=loading-b80a5a6c.mjs.map
