...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/iconbox/solid-base.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const solidBase = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { solidBase as default };
//# sourceMappingURL=solid-base-804f079c.mjs.map
