...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/card/contrast.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const contrast = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { contrast as default };
//# sourceMappingURL=contrast-90e3d6a3.mjs.map
