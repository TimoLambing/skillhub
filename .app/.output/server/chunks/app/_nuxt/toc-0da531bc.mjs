...
const _imports_0 = "" + publicAssetsURL("img/apps/tairo-toc.png");
const _imports_1 = "" + publicAssetsURL("img/apps/tairo-toc-dark.png");
const _sfc_main = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img class="border-muted-200 hover:shadow-muted-300/30 block w-full rounded-lg border transition-all duration-300 hover:shadow-xl dark:hidden"${ssrRenderAttr("src", _imports_0)} alt="Tairo toc"${_scopeId}><img class="border-muted-700 hover:shadow-muted-800/30 hidden w-full rounded-lg border transition-all duration-300 hover:shadow-xl dark:block"${ssrRenderAttr("src", _imports_1)} alt="Tairo toc dark"${_scopeId}>`);
      } else {
        return [
          createVNode("img", {
...
//# sourceMappingURL=toc-0da531bc.mjs.map
