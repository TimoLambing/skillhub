...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/tabs/boxed-icons.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const boxedIcons = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { boxedIcons as default };
//# sourceMappingURL=boxed-icons-36e4bc59.mjs.map
