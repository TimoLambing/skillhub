...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/dropdown/context-left.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const contextLeft = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { contextLeft as default };
//# sourceMappingURL=context-left-ce4ab310.mjs.map
