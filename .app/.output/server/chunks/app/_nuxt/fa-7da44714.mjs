...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/icons/fa.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const fa = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { fa as default };
//# sourceMappingURL=fa-7da44714.mjs.map
