...
import { H as useHead, Q as _sfc_main$3, f as __nuxt_component_2 } from '../server.mjs';
import { _ as _sfc_main$2 } from './BaseInputFileHeadless-8d058758.mjs';
...
import { _ as _imports_0$1 } from './placeholder-file-fb2c914d.mjs';
              ...
              if (!files?.length) {
                ...
                ssrRenderList(files, (file) => {
                  ...
                  if (file.type.startsWith("image")) {
                    ...
                    _push2(`<img class="h-14 w-14 rounded-xl object-cover object-center"${ssrRenderAttr("src", _imports_0$1)} alt="Image preview"${_scopeId}>`);
                  }
...
//# sourceMappingURL=step-4-8e2bbfdc.mjs.map
