...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/iconbox/elevation.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const elevation = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { elevation as default };
//# sourceMappingURL=elevation-03fe0407.mjs.map
