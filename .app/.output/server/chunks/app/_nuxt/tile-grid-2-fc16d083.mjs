...
import { J as useRoute, u as useRouter, g as _sfc_main$z, d as _sfc_main$x, f as __nuxt_component_2, Q as _sfc_main$3, j as _sfc_main$C, _ as _sfc_main$p, b as _sfc_main$o } from '../server.mjs';
            ...
            if (!unref(pending) && unref(data)?.data.length === 0) {
              ...
              ssrRenderList(unref(data)?.data, (item, index) => {
                _push2(ssrRenderComponent(_component_BaseCard, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<div class="flex w-full items-center gap-2"${_scopeId2}><img${ssrRenderAttr("src", item.icon)}${ssrRenderAttr("alt", item.name)} class="max-w-[46px]"${_scopeId2}><div${_scopeId2}>`);
                      ...
                      _push3(ssrRenderComponent(_component_BaseParagraph, {
                        ...
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(`<span${_scopeId3}>${ssrInterpolate(item.size)}</span><span class="px-1 text-base leading-tight"${_scopeId3}>\xB7</span><span${_scopeId3}>v${ssrInterpolate(item.version)}</span>`);
                          } else {
                            return [
                              createVNode("span", null, toDisplayString(item.size), 1),
                              createVNode("span", { class: "px-1 text-base leading-tight" }, "\xB7"),
                              createVNode("span", null, "v" + toDisplayString(item.version), 1)
                            ];
                          }
                        }),
                        _: 2
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/layouts/tile-grid-2.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=tile-grid-2-fc16d083.mjs.map
