...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/tabs-slider/curved-x2.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const curvedX2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { curvedX2 as default };
//# sourceMappingURL=curved-x2-8a183545.mjs.map
