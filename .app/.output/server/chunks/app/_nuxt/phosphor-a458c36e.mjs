...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/icons/phosphor.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const phosphor = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { phosphor as default };
//# sourceMappingURL=phosphor-a458c36e.mjs.map
