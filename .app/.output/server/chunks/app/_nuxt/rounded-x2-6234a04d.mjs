...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/tabs-slider/rounded-x2.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const roundedX2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { roundedX2 as default };
//# sourceMappingURL=rounded-x2-6234a04d.mjs.map
