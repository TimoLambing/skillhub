...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_BaseButtonIcon, { shape: "straight" }, {
  ...
  _push(ssrRenderComponent(_component_BaseButtonIcon, { shape: "rounded" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_Icon, {
  ...
  _push(ssrRenderComponent(_component_BaseButtonIcon, { shape: "curved" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_Icon, {
  ...
  _push(ssrRenderComponent(_component_BaseButtonIcon, { shape: "full" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_Icon, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/icon-button/shapes.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const shapes = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { shapes as default };
//# sourceMappingURL=shapes-ae24a870.mjs.map
