...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/tag/shadow-hover.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const shadowHover = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { shadowHover as default };
//# sourceMappingURL=shadow-hover-f2d5f19a.mjs.map
