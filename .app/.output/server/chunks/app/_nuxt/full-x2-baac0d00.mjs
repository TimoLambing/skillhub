...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/tabs-slider/full-x2.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const fullX2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { fullX2 as default };
//# sourceMappingURL=full-x2-baac0d00.mjs.map
