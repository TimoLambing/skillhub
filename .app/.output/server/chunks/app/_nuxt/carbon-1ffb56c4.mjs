...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_Icon, {
    name: "carbon:tropical-storm-tracks",
    class: "text-primary-500 block h-12 w-12"
  }, null, _parent));
  _push(`</div>`);
}
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/icons/carbon.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const carbon = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { carbon as default };
//# sourceMappingURL=carbon-1ffb56c4.mjs.map
