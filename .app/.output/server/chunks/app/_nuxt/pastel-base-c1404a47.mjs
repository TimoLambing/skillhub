...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/iconbox/pastel-base.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const pastelBase = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { pastelBase as default };
//# sourceMappingURL=pastel-base-c1404a47.mjs.map
