...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/card/elevation-hover.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const elevationHover = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { elevationHover as default };
//# sourceMappingURL=elevation-hover-7fee1606.mjs.map
