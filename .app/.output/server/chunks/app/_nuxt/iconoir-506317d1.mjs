...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/icons/iconoir.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const iconoir = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { iconoir as default };
//# sourceMappingURL=iconoir-506317d1.mjs.map
