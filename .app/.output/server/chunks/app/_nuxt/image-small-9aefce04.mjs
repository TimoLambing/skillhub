...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/snack/image-small.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const imageSmall = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { imageSmall as default };
//# sourceMappingURL=image-small-9aefce04.mjs.map
