...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/dropdown/text-left.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const textLeft = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { textLeft as default };
//# sourceMappingURL=text-left-b12c938a.mjs.map
