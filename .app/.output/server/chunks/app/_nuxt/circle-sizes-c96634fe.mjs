...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/iconbox/circle-sizes.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const circleSizes = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { circleSizes as default };
//# sourceMappingURL=circle-sizes-c96634fe.mjs.map
