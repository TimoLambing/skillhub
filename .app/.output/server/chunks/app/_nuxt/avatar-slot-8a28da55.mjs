...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/dropdown/avatar-slot.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const avatarSlot = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { avatarSlot as default };
//# sourceMappingURL=avatar-slot-8a28da55.mjs.map
