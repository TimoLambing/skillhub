    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_BaseSelect, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<option value=""${_scopeId}>Select a hero</option><optgroup label="Marvel"${_scopeId}><option value="Iron man"${_scopeId}>Iron man</option><option value="Magneto"${_scopeId}>Magneto</option><option value="Cyclops"${_scopeId}>Cyclops</option></optgroup><optgroup label="DC Comics"${_scopeId}><option value="Superman"${_scopeId}>Superman</option><option value="Batman"${_scopeId}>Batman</option></optgroup>`);
          } else {
            return [
              createVNode("option", { value: "" }, "Select a hero"),
              createVNode("optgroup", { label: "Marvel" }, [
              ...
              createVNode("optgroup", { label: "DC Comics" }, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/select/group.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=group-1e35e933.mjs.map
