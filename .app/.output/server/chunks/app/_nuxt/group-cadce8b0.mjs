...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_BaseButtonGroup, _attrs, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_BaseButtonIcon, { shape: "curved" }, {
        ...
        _push2(ssrRenderComponent(_component_BaseButtonIcon, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(ssrRenderComponent(_component_Icon, {
        ...
        return [
          createVNode(_component_BaseButtonIcon, { shape: "curved" }, {
            default: withCtx(() => [
              createVNode(_component_Icon, {
                name: "ph:moon-duotone",
                class: "h-5 w-5"
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/icon-button/group.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const group = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { group as default };
//# sourceMappingURL=group-cadce8b0.mjs.map
