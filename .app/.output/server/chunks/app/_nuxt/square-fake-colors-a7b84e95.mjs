...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/avatar/square-fake-colors.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const squareFakeColors = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { squareFakeColors as default };
//# sourceMappingURL=square-fake-colors-a7b84e95.mjs.map
