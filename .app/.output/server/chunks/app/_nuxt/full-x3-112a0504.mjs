...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/tabs-slider/full-x3.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const fullX3 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { fullX3 as default };
//# sourceMappingURL=full-x3-112a0504.mjs.map
