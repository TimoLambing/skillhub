      ...
      if (_push2) {
        ...
        return [
          activeValue === "team" ? (openBlock(), createBlock("p", {
            ...
            key: 1,
            class: "font-sans text-sm text-gray-500 dark:text-gray-400"
          }, " Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quid iudicant sensus? Primum quid tu dicis breve? Etiam beatissimum? Ne discipulum abducam, times. Quae diligentissime contra Aristonem dicuntur a Chryippo. Duo Reges: constructio interrete. ")) : createCommentVNode("", true)
        ];
      }
    }),
    _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/tabs/start.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const start = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { start as default };
//# sourceMappingURL=start-e7e05cd9.mjs.map
