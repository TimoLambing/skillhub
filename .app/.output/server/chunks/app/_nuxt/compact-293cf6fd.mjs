...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/dropdown/compact.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const compact = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { compact as default };
//# sourceMappingURL=compact-293cf6fd.mjs.map
