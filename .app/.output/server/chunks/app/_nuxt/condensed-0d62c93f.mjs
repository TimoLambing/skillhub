...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/tag/condensed.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const condensed = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { condensed as default };
//# sourceMappingURL=condensed-0d62c93f.mjs.map
