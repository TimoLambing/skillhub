...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_TairoPopover, { orientation: "end" }, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_BaseAvatar, { src: "/img/avatars/2.svg" }, null, _parent2, _scopeId));
        _push2(`<span class="text-muted-800 ms-3 font-sans text-sm font-medium dark:text-white"${_scopeId}> Maya Rosselini </span></div>`);
      } else {
        return [
          createVNode("div", { class: "flex items-center" }, [
            createVNode(_component_BaseAvatar, { src: "/img/avatars/2.svg" }),
            createVNode("span", { class: "text-muted-800 ms-3 font-sans text-sm font-medium dark:text-white" }, " Maya Rosselini ")
          ])
        ];
      }
    }),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/popover/dual-right.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const dualRight = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { dualRight as default };
//# sourceMappingURL=dual-right-693894fe.mjs.map
