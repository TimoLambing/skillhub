...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/icons/lucide.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const lucide = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { lucide as default };
//# sourceMappingURL=lucide-dd9f2e0f.mjs.map
