...
const _imports_0 = "" + publicAssetsURL("img/apps/tairo-circular-menu.png");
const _imports_1 = "" + publicAssetsURL("img/apps/tairo-circular-menu-dark.png");
const _sfc_main = {};
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/tairo/circular-menu.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const circularMenu = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { circularMenu as default };
//# sourceMappingURL=circular-menu-a1e807a2.mjs.map
