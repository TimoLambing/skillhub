...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/snack/image-light.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const imageLight = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { imageLight as default };
//# sourceMappingURL=image-light-810dc027.mjs.map
