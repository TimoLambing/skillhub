...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/tabs/boxed.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const boxed = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { boxed as default };
//# sourceMappingURL=boxed-6392a408.mjs.map
