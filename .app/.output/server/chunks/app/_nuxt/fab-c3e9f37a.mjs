...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/documentation/examples/icons/fab.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const fab = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { fab as default };
//# sourceMappingURL=fab-c3e9f37a.mjs.map
