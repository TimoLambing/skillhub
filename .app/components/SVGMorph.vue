    ...
    <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
      ...
      <defs>
        <clipPath id="clip-path">
          <path id="morphClip" d="M42.3,-70.7C56.7,-65,71.4,-57.4,80.2,-45.3C89,-33.2,91.9,-16.6,85.7,-3.6C79.5,9.5,64.3,18.9,55.3,30.6C46.3,42.3,43.4,56.3,35.2,64.8C27,73.3,13.5,76.4,-0.8,77.8C-15.1,79.2,-30.2,78.8,-43.5,73.3C-56.8,67.7,-68.3,56.9,-74.8,43.8C-81.2,30.7,-82.7,15.4,-81,1C-79.3,-13.4,-74.5,-26.8,-68.7,-41.1C-62.9,-55.3,-56.1,-70.4,-44.5,-77.8C-32.9,-85.2,-16.5,-84.8,-1.2,-82.6C14,-80.5,27.9,-76.5,42.3,-70.7Z" transform="translate(90 100) scale(0.8)" />
        </clipPath>
      </defs>
      <defs>
      ...
      <image width="200" height="200" href="/img/men.webp" clip-path="url(#clip-path)" />
    </svg>
  </div>
</template>
...
#morphClip {
  animation: morphClip 5s infinite alternate;
}
</style>
